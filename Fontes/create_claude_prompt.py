# -*- coding: utf-8 -*-
"""
Script para gerar o PROMPT_CLAUDE_CODE_AUDITORIA.md
Autor: Thiago Carvalho
Data: 11 de Setembro de 2026
"""

prompt_content = r"""# PROMPT DE AUDITORIA PROFUNDA PARA O CLAUDE CODE
...
with open(r"C:\MathDoCarvalho\PROMPT_CLAUDE_CODE_AUDITORIA.md", "w", encoding="utf-8") as f:
    f.write(prompt_content)

with open(r"C:\MathDoCarvalho\P_NP\Publicacoes\PROMPT_CLAUDE_CODE_AUDITORIA.md", "w", encoding="utf-8") as f:
    f.write(prompt_content)

print("Arquivos criados com sucesso na raiz e em Publicacoes!")
